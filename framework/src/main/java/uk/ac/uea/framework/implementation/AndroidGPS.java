...
public class AndroidGPS implements GPS{
     ...
     */
    @Override
    public ArrayList<MarkerOptions> readMap() throws IOException {
        ...
        InputStream stream = context.getResources().openRawResource(R.raw.mapdata);
        br = new BufferedReader(new InputStreamReader(stream));
        ArrayList<MarkerOptions> markerOptionsArray = new ArrayList<>();
        ...
        while ((line = br.readLine()) != null) {
            ...
            markerOptionsArray.add(markerOption);
     ...
     */
    @Override
    public MarkerOptions saveLocationAsDestination(Location location, String markerName) {
        setDestinationLocation(location);
        //gMap.addMarker(new MarkerOptions().position(new LatLng(location.getLatitude(),location.getLongitude())));
        MarkerOptions markerOption = new MarkerOptions();
        markerOption.position(new LatLng(location.getLatitude(), location.getLongitude())).title(markerName);
